  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 text-white flex items-center justify-center px-4 sm:px-6">
      ...
      >
        ...
        <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-6 sm:p-8" role="region" aria-label="Login form container">
          {error && (
            <motion.div
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
          ...
          <form onSubmit={handleSubmit} className="space-y-6" aria-label="Login form">
            ...
            <motion.button
              ...
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-white text-purple-900 rounded-xl font-semibold hover:bg-opacity-90 transition disabled:opacity-50 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-purple-800"
            >
                ...
                {['google', 'apple'].filter(p => availableProviders.includes(p)).map(provider => {
                  ...
                  return (
                    <motion.button
                      ...
                      disabled={isLoading}
                      type="button"
                      className={`w-full py-2.5 sm:py-3 rounded-xl font-medium transition flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer text-sm sm:text-base focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-800 ${
                        provider === 'google' 
                    ...
                    {availableProviders.filter(p => !['google', 'apple'].includes(p)).map(provider => {
                      ...
                      return (
                        <motion.button
                          ...
                          disabled={isLoading}
                          type="button"
                          className={`flex-1 py-2 px-3 rounded-lg font-medium transition flex items-center justify-center disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-purple-800 ${info.bgColor}`}
                          title={`Sign in with ${info.name}`}
                        >
                          {info.icon}
